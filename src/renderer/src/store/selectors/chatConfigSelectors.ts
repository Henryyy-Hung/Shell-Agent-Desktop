...
export const selectCurrentTopicId = (state: RootState) =>
  state.chatConfig.currentTopicId;

export const selectCurrentRemoteShell = (state: RootState) =>
  state.chatConfig.currentRemoteShell;

export const selectWebSearchEnabled = (state: RootState) =>
  state.chatConfig.webSearchEnabled;
