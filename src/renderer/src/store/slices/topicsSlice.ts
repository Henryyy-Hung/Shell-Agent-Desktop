...
const topicsSlice = createSlice({
  ...
  reducers: {
    ...
    addMessageToTopic(state, action: PayloadAction<{ topicId: string; messageId: string }>) {
    ...
    removeMessageFromTopic(state, action: PayloadAction<{ topicId: string; messageId: string }>) {
      const { topicId, messageId } = action.payload
...
export const { insertTopic, updateTopic, removeTopic, addMessageToTopic, removeMessageFromTopic } =
  topicsSlice.actions
