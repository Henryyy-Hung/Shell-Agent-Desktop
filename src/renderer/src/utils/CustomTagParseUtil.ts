...
import {
  ChatContentTypeEnum,
  ChatContentTypeEnumType,
} from '@renderer/enums/ChatContentTypeEnum';
...
class CustomTagParseUtil {
  ...
  private static createRegex(tags: string[]) {
    // 先处理成正则的模式
  ...
  public static parseCustomTags = (
    ...
    const regex = CustomTagParseUtil.createRegex(
      CustomTagParseUtil.specialTags,
    );
